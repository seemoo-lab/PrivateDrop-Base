...
struct Log {
    ...
    static func logEmoji(type: OSLogType) -> String {
    ...
    static func attachToLogFile(type: OSLogType, message: StaticString, _ a: [CVarArg]) {
            ...
            DispatchQueue.main.async {
                ...
                let typeEmoji = self.logEmoji(type: type)
    ...
    public struct LogSystem {
        ...
        static let server = LogSystem(OSLog(subsystem: "OpenDrop-Server", category: "Server"))
        static let client = LogSystem(OSLog(subsystem: "OpenDrop-Client", category: "Client"))
    }
}
